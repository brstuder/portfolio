...
![image](..//images/kubecost/efficiency.png){: .dia-light }
...
> *CPU Usage = rate(container\_cpu\_usage\_seconds\_total) over the time window* & RAM Usage = avg(container\_memory\_working\_set\_bytes) over the time window*
...
> *idle\_cost = sum(cluster\_cost) - (cpu\_allocation\_cost + ram\_allocation\_cost + gpu\_allocation\_cost)*
...
> *idle\_cost = sum(node\_cost) - (cpu\_allocation\_cost + ram\_allocation\_cost + gpu\_allocation\_cost)*
