...
![Network Monitoring](..//images/kubecost/network-monitoring1.png){: .dia-light }

### Getting started

Network Monitoring is powered by the network costs daemonset, which must be manually enabled before Network Monitoring can be utilized. See our Network Cost Configuration doc for an overview on enabling the daemonset, as well as how to make additional configurations to your network costs in Kubecost.
...
![Network Monitoring icons](..//images/kubecost/network-monitoring2.png){: .dia-light }
